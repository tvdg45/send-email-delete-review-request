<?php
	...
	$message .= "<div style=\"text-align: left\">\r\n";
        ...
        $message .= "</div>\r\n";
        $message .= "<div style=\"text-align: left\">\r\n";
        $message .= "<p><a href='" . $domain . "/product-reviews.html?code=" . $security_code . "&review=" . $row_id . "&product=" . $item_id . "&sort=Low%20to%20high&perpage=10&page=1&enablereviewdeletion=Enable&search=Search'>Delete review</a></p>\r\n";
        $message .= "</div>\r\n";
        $message .= "<div style=\"text-align: left\">\r\n";
